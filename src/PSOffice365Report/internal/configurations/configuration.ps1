...
Set-PSFConfig -Module $Env:ModuleName -Name 'Settings.GraphApiVersion' -Value "v1.0" -Initialize -Validation 'string' -Description "What version of Graph API module is useing."
Set-PSFConfig -Module $Env:ModuleName -Name 'Settings.GraphApiUri' -Value "https://graph.microsoft.com" -Initialize -Validation 'string' -Description "What url of Graph API module is useing."
Set-PSFConfig -Module $Env:ModuleName -Name 'Settings.AuthUri' -Value "https://login.microsoftonline.com" -Initialize -Validation 'string' -Description "What url authentication of Graph API module is useing."
...
Set-PSFConfig -Module $Env:ModuleName -Name 'Template.Office365.Folder' -Value (Join-Path -Path (Join-Path -Path $ModuleRoot -ChildPath "internal") -ChildPath 'ortemplate') -Validation 'string' -Description "Folder of report templates."
Set-PSFConfig -Module $Env:ModuleName -Name 'Template.Office365.UsageReport' -Value ('Office365UsageReport') -Initialize -Validation 'string' -Description "Folder name of Office 365 Usage eport templates."
