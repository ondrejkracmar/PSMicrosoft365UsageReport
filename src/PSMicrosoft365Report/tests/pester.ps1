...
Remove-Module PSMicrosoft365Report -ErrorAction Ignore
Import-Module "$PSScriptRoot\..\PSMicrosoft365Report.psd1"
Import-Module "$PSScriptRoot\..\PSMicrosoft365Report.psm1" -Force
