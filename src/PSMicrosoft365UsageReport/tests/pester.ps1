...
Remove-Module PSMicrosoft365UsageReport -ErrorAction Ignore
Import-Module "$PSScriptRoot\..\PSMicrosoft365UsageReport.psd1"
Import-Module "$PSScriptRoot\..\PSMicrosoft365UsageReport.psm1" -Force
