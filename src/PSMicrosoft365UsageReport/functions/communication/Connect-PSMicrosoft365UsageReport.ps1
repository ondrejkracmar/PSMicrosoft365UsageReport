function Connect-PSMicrosoft365UsageReport {
	...
	.EXAMPLE
		PS C:\> Connect-PSMicrosof365tUsageReport -ClientID $clientID -TenantID $tenantID -TenantName contoso -Certificate $cert

		Connect to the specified tenant using a certificate

	.EXAMPLE
		PS C:\> Connect-PSMicrosof365tUsageReport -ClientID $clientID -TenantID $tenantID -TenantName contoso -DeviceCode
