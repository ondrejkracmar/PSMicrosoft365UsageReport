...
Remove-Module PSOffice365Reports -ErrorAction Ignore
Import-Module "$PSScriptRoot\..\PSOffice365Reports.psd1"
Import-Module "$PSScriptRoot\..\PSOffice365Reports.psm1" -Force
